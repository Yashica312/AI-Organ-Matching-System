import { Heart, LayoutDashboard, LogOut, HeartHandshake, UserPlus, GitCompareArrows } from "lucide-react";
...
const mainNav = [
  ...
  { title: "Match", url: "/matching", icon: GitCompareArrows },
  { title: "Donors", url: "/add-donor", icon: HeartHandshake },
  { title: "Recipients", url: "/add-recipient", icon: UserPlus },
];
